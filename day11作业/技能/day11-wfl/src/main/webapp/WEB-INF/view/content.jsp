	...
	<div class="modal fade" id="modal_user_echarts" role="dialog" aria-labelledby="modal_user_echarts" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body" style="width: 400px;height: 400px" id="main">
				<div class="modal-body" style="width: 400px;height: 400px" id="main2">
				<div class="modal-body" style="width: 400px;height: 400px" id="main3">				
				</div>
				<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
			</div>
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_echarts").click(function(){
	    		var echarts1=  echarts.init(document.getElementById("main"));
	    		 var echarts2=  echarts.init(document.getElementById("main2"));
	    		var echarts3=  echarts.init(document.getElementById("main3")); 
    			...
    			$.ajax({
    			    ...
    			    success:function(res){
    			    	...
    			    	res.list.forEach(function(content){
    			    		xdata.push(content.cname);
    			    		ydata.push({value:content.num,name:content.cname});
    			    	});
    			    	if(res.success){
    		    			//饼图
    			    		option1 = {
