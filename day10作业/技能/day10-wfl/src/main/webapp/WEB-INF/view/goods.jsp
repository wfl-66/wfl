...
<body class="gray-bg">
	...
	<div class="modal fade" id="modal_user_addtype" role="dialog" aria-labelledby="modal_user_addtype" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_addtype" method="post" action="reserveGoodstype.htm">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="addtype_form_user_btn">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	$(function () {
	    ...
	    var validator = $("#form_addtype").validate({
    		submitHandler: function(form){
   		      $(form).ajaxSubmit({
   		    	dataType:"json",
   		    	success: function (data) {
	    ...
	    $("#addtype_form_user_btn").click(function(){
	    	$("#form_addtype").submit();
	    });
	});
