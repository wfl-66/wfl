...
<body class="gray-bg">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>
									...
									<input type="checkbox" id="pLike3" name="pLike" value="美女" aria-required="true" required/>美女
								</td>
								<td>&nbsp;&nbsp;</td>
								<td>性别：</td>
								<td>
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_import" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="from_import" action="importPerson.htm" method="post" enctype="multipart/form-data">
	...
	<!--报表对话框 -->
	<div class="modal fade" id="modal_user_echarts" role="dialog" aria-labelledby="modal_user_echars" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
				...
				<div class="modal-body" style="width: 500px;height: 500px" id="main">
	...
	$(function () {
	    ...
	    var validator = $("#from_import").validate({
    		submitHandler: function(form){
   		      $(form).ajaxSubmit({
   		    	dataType:"json",
   		    	success: function (data) {
	...
	function initEditUser(getSelection){
		...
		$("input[value='"+getSelection.pSex+"']").attr("checked",true);
