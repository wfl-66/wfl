...
<body class="gray-bg">
					...
					<form id="form_user" method="post" action="reserveStu.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<input type="radio" id="sdsex" name="sdsex" value = "女" aria-required="true" required/>女
								</td>
							</tr>
								<tr>
								<td>爱好：</td>
								<td><input type="checkbox" id="sdhobby1" name="sdhobby" value="篮球" aria-required="true" required/>篮球
									...
									<input type="checkbox" id="sdhobby3" name="sdhobby" value="排球" aria-required="true" required/>排球
									</td>
								<td>&nbsp;&nbsp;</td>
								<td>生日：</td>
								<td><input type=date id="sdbirth" name="sdbirth" aria-required="true" required/>
								</td>
							</tr>
							<tr>
								<td>专业：</td>
	...
	<div class="modal fade" id="modal_user_addMajor" role="dialog" aria-labelledby="modal_user_addMajor" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_addMajor" method="post" action="reserveMajor.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>专业名称：</td>
    			...
    			$.ajax({
    			    ...
    			    success:function(res){
    			    	...
    			    	res.list.forEach(function(stu){
    			    		...
    			    		ydata.push({value:stu.num,name:stu.mdname});
    			    	});
    			    	if(res.success){
