...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="text" name="sname" class="sname" id="txt_search_username" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveStudent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td valign="middle">入学日期：</td>
								<td><input type="date" id="rtime" name="rtime"
									class="form-control" aria-required="true" required/></td>
							</tr>
						</table>
	    			...
	    			$.ajax({
	    			    ...
	    			    success:function(res){
	    			    	...
	    			    	for (var i = 0; i < obj.length; i++) {
	    			    		xdate[i]={value:obj[i].num,name:obj[i].tname};
							}
	...
	function initEditUser(getSelection){
		...
		$('#rtime').val(new Date(getSelection.rtime).Format('yyyy-MM-dd'));
