...
<body class="gray-bg">
				...
				<div class="input-group">
					...
					<select class="form-control" name="dId" id = "txt_search_roleid">
						...
						<c:forEach items="${dList }" var="r">
						 	<option value="${r.dId }">${r.dName }</option>
						</c:forEach>
                	</select>
				</div>
			 </div>
					...
					<form id="form_user" method="post" action="reserveEmp.htm" enctype="multipart/form-data">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>生日：</td>
								<td><input type="date" id="birthday" name="birthday" readonly="readonly"
									class="form-control" aria-required="true" required/></td>
							</tr>
							<tr>
								<td>性别：</td>
							...
							<td>头像：</td>
								<td>
								<img src="" id = "picc" src="" width="50px" height="50px"> 
								<input type="file" id="picc" name="picc"/>
	...
	function initEditUser(getSelection){
		...
		$('#picc').attr('src',"/pic/"+getSelection.picc);
