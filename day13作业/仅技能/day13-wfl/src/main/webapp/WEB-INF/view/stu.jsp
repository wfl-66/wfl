					...
					<form id="form_user" method="post" action="reserveStu.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<tr>
								<td>爱好：</td>
								<td><input type="checkbox" id="sHobby1" name="sHobby" value="篮球" aria-required="true" required/>篮球
									<input type="checkbox" id="sHobby2" name="sHobby" value="足球" aria-required="true" required/>足球
									<input type="checkbox" id="sHobby3" name="sHobby" value="排球" aria-required="true" required/>排球
									</td>
								<td>&nbsp;&nbsp;</td>
								<td>生日：</td>
								<td><input type=date id="sBirth" name="sBirth" aria-required="true" required/>
								</td>
							</tr>
							<tr>
								<td>专业：</td>
